...
class EDAReport:
    ...
    def generate_inspection_report(self):
        """Generates a text summary of the dataset."""
    ...
    def plot_anomalies_boxplot(self):
        ...
        for col in numeric_cols:
            try:
                ...
                pass # Skip if plotting fails for a specific column
    ...
    def plot_categorical_anomalies(self):
        ...
        for col in cat_cols:
            try:
                ...
                fig = px.bar(counts, x=col, y='Count', title=f"Distribution of {col}", color='Count')
